...
class FastImageCacheHelper {
    ...
    class func setUp(delegate: FICImageCacheDelegate) {
        ...
        let smallImageFormat = FICImageFormat(name: KMSmallImageFormatName, family: KMPhotoImageFormatFamily, imageSize: KMSmallImageSize, style: .Style8BitGrayscale, maximumCount: squareImageFormatMaximumCount, devices: .Phone, protectionMode: .None)
        imageFormats.append(smallImageFormat)
        
        let bigImageFormat = FICImageFormat(name: KMBigImageFormatName, family: KMPhotoImageFormatFamily, imageSize: KMBigImageSize, style: .Style8BitGrayscale, maximumCount: squareImageFormatMaximumCount, devices: .Phone, protectionMode: .None)
